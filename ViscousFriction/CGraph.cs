...
namespace ViscousFriction
{
    public class CGraph
    {
        public enum graphCenter { MIDDLE, MIDDLELEFT, BOTTOMLEFT }
        ...
        public void Setup(graphCenter grCenter, String xAxisName, double xAxisMaxVal, String yAxisName, double yAxisMaxVal) {
            this.xAxisName = xAxisName;
            this.yAxisName = yAxisName;

            switch (grCenter)
            {
                case graphCenter.MIDDLE:
                    this.grCenter.X = pb.Width / 2;
                    this.grCenter.Y = pb.Height / 2;
                    break;
                case graphCenter.MIDDLELEFT:
                    this.grCenter.X = 0;
                    this.grCenter.Y = pb.Height / 2;
                    break;
                case graphCenter.BOTTOMLEFT:
                    this.grCenter.X = 0;
                    this.grCenter.Y = pb.Height;
                    break;
            }
        ...
        public void MakeGrid()
        {
            ...
            AddString(pb.Width - 30, grCenter.Y - 16, xAxisName, false);
            AddString(0, 0, "0");
